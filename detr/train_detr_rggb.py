...
Vanilla DETR training entry for RGGB (.npy) detection data.
This script reuses the original `project/transformer/data` pipeline so
RGGB loading/resize/padding/target generation behavior stays consistent.
"""
...
from models.detr_rggb import DETRRGGB
...
def set_backbone_trainable(model: DETRRGGB, trainable: bool) -> None:
...
def build_arg_parser() -> argparse.ArgumentParser:
    ap = argparse.ArgumentParser("Vanilla DETR RGGB trainer")
    ap.add_argument("--cfg", type=str, default=None, help="Path to JSON with argparse key-values.")
    ...
    ap.add_argument("--out", type=str, default="/home/ryan529/project/detr/runs/detr_rggb")
